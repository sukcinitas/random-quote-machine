...
App showcases a random quote from 13 I've hardcoded (at the time wasn't intending to use any API). Quote can be tweeted, tweet field is prefilled with text automatically.
